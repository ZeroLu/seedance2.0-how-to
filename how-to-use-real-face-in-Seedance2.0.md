# The Ultimate Guide to Using Real Faces in Seedance 2.0 (May 2026 Update)

**Disclaimer:** This guide is strictly for educational purposes and authorized projects. Do not use these techniques for non-consensual content, deepfakes, or impersonating public figures. Bypassing algorithms may violate Seedance 2.0’s Terms of Service and risk account suspension. The author assumes no liability for misuse; proceed entirely at your own risk.

---

Hi fellow creators!

I am Zero Lu, a content creator who uses Seedance 2.0 a lot!
...
#### With your own face using the Jimeng app:
...
And here is the resulting video with my real face in it (with Jimeng watermarks):

https://github.com/user-attachments/assets/cc7a29ea-45f6-4052-9cc0-3fae0b76dcde

#### With your own face using XYQ:
1. Open the app and navigate to the **Third tab** -> **发咕咕** -> **发咕咕**. Enter **@**, choose **创建新角色**, and then select **录制真人形象**.
...
3. Navigate to **公共角色**, choose one, and add it to the scene. Then, create any video with that character! 

<img width="500" alt="20260512085824" src="https://github.com/user-attachments/assets/d37f5d27-b479-4af2-a8c8-17cb1be02a0c" />

*Special note: If you are using the same account, your avatar created with the XYQ app will also appear on the XYQ website under **分身角色**!*
...
3. Sign in with Google, X, or sign up with email.
...
4. Simply drag and drop your portrait onto the canvas. Then, drag a line out and choose **Video Node**.

<img width="500" alt="20260512091349" src="https://github.com/user-attachments/assets/dd726d2d-2517-446e-8f00-7afd33a27bea" />

5. Select **Seedance 2.0 Stable** or **Seedance 2.0 Fast Stable**. You can hover over the thumbnail of the image and click **@imageN** to reference the image. Then enter your prompt, and hit **Generate**.
...
6. In no time, your video is ready.
...
This involves prompting the AI to view the image as a 2D character design reference sheet rather than a real human photograph.
...
This is a pretty weird method, but it works great! I am probably the first person on the internet who came up with this processing prompt.

This involves using prompts to visually divide or grid the face, which confuses the facial recognition detector but still allows the AI to render the features.
...
1. Use GPT Image 2 to process the input photo into a split-view colored pencil image.
...
2. Use the output image for Seedance 2.0. Make sure to add the following text to your prompt to ensure that the video is realistic.
